...
def sample_size_bound(n, d, b, k, epsilon, delta):
    """
...
# vtrace1(x, y, z, a, b, c), 6 variables, up to degree 5,
# bound 20, selected max terms 20 -- DIG puts bound and subset as the same value and call it as UGLY_FACTOR
print(sample_size_bound(n=6, d=5, b=20, k=20, epsilon=0.01, delta=0.2))
