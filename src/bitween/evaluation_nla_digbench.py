from bitween.main import infer_invariants, infer_invariants_and_check_correctness
...
def dijkstra():
    ...
    func_name = "dijkstra"
    infer_invariants(file_path, func_name, max_degree=3, n=20, bound=16, milp=solver)
...
def fermat1():
    ...
    func_name = "fermat1"
    infer_invariants(file_path, func_name, max_degree=2, n=200, milp=solver)
...
def ps1():
    ...
    func_name = "ps1"
    infer_invariants(file_path, func_name, max_degree=1, n=10, milp=solver)


def ps2():
    file_path = "./benchmarks/bitween/dig/ps2.c"
    func_name = "ps2"
    infer_invariants(file_path, func_name, max_degree=2, n=10, bound=4, milp=solver)


def ps3():
    file_path = "./benchmarks/bitween/dig/ps3.c"
    func_name = "ps3"
    infer_invariants(file_path, func_name, max_degree=3, n=10, milp=solver)


def ps4():
    file_path = "./benchmarks/bitween/dig/ps4.c"
    func_name = "ps4"
    infer_invariants(file_path, func_name, max_degree=4, n=12, milp=solver)
