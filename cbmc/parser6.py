...
class ExpressionInfo:
    def __init__(self, expr, line_num, order, variable, function):
        self.expr = expr
...
if __name__ == "__main__":
    ...
    # Print the expressions and their details
    print("\nExtracted Expressions:")
    for expr_info in expressions:
        print(
            f"Expression: {expr_info.expr}, Line: {expr_info.line_num}, Order: {expr_info.order}, Variable: {expr_info.variable}, Function: {expr_info.function}"
        )
